...
// If the calling line includes a value for the number of tracks, add that
// value to the album’s Object. Make at least one new function call that
...
let album4 = make_album('Taylor Swift', '1989', 13);
console.log(album1);
console.log(album2);
console.log(album3);
console.log(album4);
